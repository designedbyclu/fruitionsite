...
const PAGE_TITLE = 'Welcome Home, Rose';
const PAGE_DESCRIPTION = '';

/* Step 4: enter a Google Font name, you can choose from https://fonts.google.com */
const GOOGLE_FONT = 'Playfair Display';
...
async function fetchAndApply(request) {
  ...
  if (url.pathname.startsWith('/app') && url.pathname.endsWith('js')) {
    ...
    response = new Response(body.replace(/www.notion.so/g, MY_DOMAIN).replace(/notion.so/g, MY_DOMAIN)
      .replace(/${MY_NOTION_DOMAIN}.notion.site/g, MY_DOMAIN), response);
